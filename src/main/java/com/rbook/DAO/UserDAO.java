...
public interface UserDAO extends Neo4jRepository<UserNode, Long> {
	...
	@Query("CREATE (n:User {username:{0}, password:{1}, ID:{2}, totalAccount:{3}, rankStatus:{4}})")
	public void addUser(String name, String password, String identity, int total, int rank);
